 ...
 */
var module = angular.module('chuangtou', ['ngRoute'])
module.config(['$routeProvider', function ($routeProvider) {
    $routeProvider.when('/venture/chuangtou/:page', {
        templateUrl: 'venture/chuangtou/view.html',
        controller: 'chuangtouController'
    })
}]);
module.controller('chuangtouController', ['$scope','$route','$routeParams','$http', function ($scope,$route,$routeParams,$http) {
    $scope.subjects = [];
    $scope.name = "创业";
